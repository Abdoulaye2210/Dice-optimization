...
import seaborn
from Cobb_Douglas import Douglas
...
#    print(scc_period, e_bump, c_bump)
    ...
    YYY = Douglas(num_step, tstep, YGROSS_0)
    ...
    for i in range(2, num_times+1):
        ...
        YGROSS[i] = YYY[i] ### geometric brownian motion ###
...
def plotStateToFile(fileName, years, output, x):
    ...
    MIU = x[0:num_times]
    title = 'Optimized: Carbon Emission Control Rate (MIU)'
    xlabel = 'Years'
    ylabel = 'Rate'
